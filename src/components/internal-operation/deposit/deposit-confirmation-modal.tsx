...
export function DepositConfirmationModal({ isOpen, onClose, formData }: DepositConfirmationModalProps) {
  ...
  const createDepositMutation = useMutation({
    ...
    onError: (error: any) => {
      ...
      toast({
        title: "Error",
        description: error?.response?.data?.message || error?.message || "Failed to create deposit",
        variant: "destructive",
      });
    },
  });
