...
interface CreateFixedUtilityModalProps {
  isOpen: boolean;
  onClose: () => void;
  onNext: (data: any) => void;
}

export function CreateFixedUtilityModal({ isOpen, onClose, onNext }: CreateFixedUtilityModalProps) {
  ...
  useEffect(() => {
    if (selectedSourceAccount && amount && date) {
      ...
      const generatedDescription = `Fixed Utility - ${selectedSourceAccount.name} - ${formattedDate}`;
