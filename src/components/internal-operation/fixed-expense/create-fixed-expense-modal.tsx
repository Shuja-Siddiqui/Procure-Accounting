...
export function CreateFixedExpenseModal({ isOpen, onClose, onNext }: CreateFixedExpenseModalProps) {
  ...
  useEffect(() => {
    if (selectedSourceAccount && amount && date) {
      ...
      const generatedDescription = `Fixed Expense - ${selectedSourceAccount.name} - ${formattedDate}`;
