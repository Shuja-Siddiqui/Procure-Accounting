...
interface CreateMiscellaneousModalProps {
  isOpen: boolean;
  onClose: () => void;
  onNext: (data: any) => void;
}

export function CreateMiscellaneousModal({ isOpen, onClose, onNext }: CreateMiscellaneousModalProps) {
  ...
  useEffect(() => {
    if (selectedSourceAccount && amount && date) {
      ...
      const generatedDescription = `Miscellaneous transaction - ${selectedSourceAccount.name} - ${formattedDate}`;
